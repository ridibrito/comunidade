...
import { Settings, Globe, Palette, Database, Shield } from "lucide-react";
    ...
    <Container>
      <Section>
        <PageHeader
          ...
          description="Configure as configurações básicas da plataforma"
          icon={Settings}
        />
        ...
        <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  placeholder="Comunidade Singular"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-light-text dark:text-dark-text mb-2">
              ...
              <div>
                ...
                <input 
                  type="url" 
                  className="w-full px-3 py-2 border border-light-border dark:border-dark-border rounded-lg bg-light-surface dark:bg-dark-surface text-light-text dark:text-dark-text"
                  placeholder="https://comunidade.aldeiasingular.com.br"
                />
              </div>
            </div>
          </ModernCard>
          ...
          <ModernCard>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-light-border dark:border-dark-border rounded-lg p-6 text-center">
                  <p className="text-light-muted dark:text-dark-muted">
                    Arraste e solte o favicon aqui ou clique para selecionar
                  </p>
                </div>
              </div>
            </div>
          ...
          <ModernCard>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-light-text dark:text-dark-text">Manutenção</h3>
                  <p className="text-sm text-light-muted dark:text-dark-muted">
                    Colocar a plataforma em modo de manutenção
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-light-text dark:text-dark-text">Registro de Novos Usuários</h3>
                  <p className="text-sm text-light-muted dark:text-dark-muted">
                    Permitir registro público de novos usuários
                  </p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
          ...
          <ModernCard>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-medium text-light-text dark:text-dark-text">2FA Obrigatório</h3>
                  <p className="text-sm text-light-muted dark:text-dark-muted">
