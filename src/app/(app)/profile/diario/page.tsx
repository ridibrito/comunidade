      ...
      <div className="flex h-full">
        <aside className="hidden md:block w-[280px] xl:w-[340px] border-r-2 border-[var(--border)] bg-[var(--surface)] p-3">
          ...
          <ul className="text-sm space-y-1">
            ...
            <li><a aria-current="page" className="block px-3 py-2 rounded-xl bg-[var(--hover)]" href="#">Diário</a></li>
          </ul>
        </aside>
        <section className="flex-1 p-8 overflow-y-auto">
          <PageHeader title="Diário" subtitle="Registros do dia por filho" />
          <Card>
            <div className="text-sm text-[var(--foreground)]/70">Em breve: diário rápido para registro dos responsáveis.</div>
          </Card>
        </section>
      </div>
    </main>
