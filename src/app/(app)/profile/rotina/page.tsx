      ...
      <div className="flex h-full">
        <aside className="hidden md:block w-[280px] xl:w-[340px] border-r-2 border-[var(--border)] bg-[var(--surface)] p-3">
          ...
          <ul className="text-sm space-y-1">
            ...
            <li><a href="/profile/anamnese" className="block px-3 py-2 rounded-xl hover:bg-[var(--hover)]">Anamnese</a></li>
            <li><a aria-current="page" className="block px-3 py-2 rounded-xl bg-[var(--hover)]" href="#">Rotina</a></li>
        ...
        <section className="flex-1 p-8 overflow-y-auto">
          ...
          <Card>
            <div className="text-sm text-[var(--foreground)]/70">Em breve: configuração de rotina por filho.</div>
          </Card>
        </section>
      </div>
    </main>
