      ...
      <div className="flex h-full">
        <aside className="hidden md:block shrink-0 h-screen bg-light-surface dark:bg-dark-surface transition-all duration-300 shadow-sm w-[240px] xl:w-[280px] p-4">
          ...
          <ul className="text-sm space-y-2">
            ...
            <li>
              <a aria-current="page" href="/profile/rotina" className="flex items-center gap-3 rounded-xl transition-colors px-4 py-3 cursor-pointer w-full text-left active-brand-subtle text-brand-accent">
                <CalendarDays size={18} className="text-purple-600 dark:text-purple-400" />
                <span className="text-purple-600 dark:text-purple-400">Rotina</span>
              </a>
            </li>
            <li>
        ...
        <Section>
          <PageHeader title="Rotina" subtitle="Rotina diária por filho" />
          <Card className="shadow-sm border border-light-border dark:border-dark-border rounded-lg">
            <div className="text-sm text-light-muted dark:text-dark-muted">Em breve: configuração de rotina por filho.</div>
          </Card>
        </Section>
      </div>
    </Container>
