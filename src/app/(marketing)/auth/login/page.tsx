          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="mt-1 w-full h-11 rounded-xl bg-transparent border border-gray-300 dark:border-dark-border px-3 pr-10 text-gray-900 dark:text-dark-text placeholder-gray-500 dark:placeholder-dark-muted focus:border-brand-accent focus:ring-1 focus:ring-brand-accent"
                placeholder="Sua senha"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:text-dark-muted dark:hover:text-dark-text transition-colors"
              >
                {showPassword ? (
