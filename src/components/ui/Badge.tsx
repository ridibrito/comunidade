...
export default function Badge({
  ...
  const variantClasses = {
    default: "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-100 shadow-sm",
    ...
    outline: "text-gray-700 dark:text-gray-100 shadow-sm bg-white dark:bg-gray-800"
  };
